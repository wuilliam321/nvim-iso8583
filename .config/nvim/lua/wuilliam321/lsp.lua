...
local language_servers = {
  "html", "cssls", "vuels", "jsonls", "pylsp", "groovyls", "clangd",
  "dockerls", "yamlls", "terraformls",
  kotlin_language_server = {
    ...
    cmd = {
      "/Users/wuilliam.lacruz/Downloads/kotlin-language-server/" .. "server/build/install/server/bin/kotlin-language-server"
    },
    filetypes = { "kotlin" },
  },
  gopls = {
  ...
  sumneko_lua = {
    cmd = {
      "/Users/wuilliam.lacruz/Downloads/lua-language-server/" .. "bin/macOS/lua-language-server", "-E",
