...
local mappings = {
  -- find
  {
    'n',
    '<leader>pa',
    '<cmd>lua require("wuilliam321.finders").projects()<cr>',
    opts,
  },
  {
    'n',
    '<leader>pp',
    '<cmd>lua require("wuilliam321.finders").git_files()<cr>',
    opts,
  },
  {
    'n',
    '<leader>pf',
    '<cmd>lua require("wuilliam321.finders").project_find()<cr>',
    opts,
  },
  {
    'n',
    '<leader>pg',
    '<cmd>lua require("wuilliam321.finders").project_grep()<cr>',
    opts,
  },
  {
    'n',
  ...
  {'n', '<leader>ff', ':Vex<cr>', opts},
  {
    'n',
    '<leader>ph',
    '<cmd>lua require("wuilliam321.finders").help_tags()<cr>',
    opts,
  },
  {
    'n',
    '<leader>di',
    '<cmd>lua require("wuilliam321.finders").buffer_diagnostics()<cr>',
    opts,
  },
  {
    'n',
    '<leader>fg',
    '<cmd>lua require("wuilliam321.finders").buffer_find()<cr>',
    opts,
  },
  {
    'n',
    '<leader>cs',
    '<cmd>lua require("wuilliam321.finders").cheatsheets({filetype = vim.bo.filetype })<cr>',
    opts,
  },
  ...
  {'n', '<leader>pd', '<cmd>PrettierAsync<cr>', opts},
  {
    'n',
    'z=',
    '<cmd>lua require("telescope.builtin").spell_suggest(require("telescope.themes").get_dropdown({ previewer = false }))<cr>',
    opts,
  },
  ...
  -- testing/debugging
  {
    'n',
    '<leader>da',
    '<cmd>call vimspector#LaunchWithSettings( #{ configuration: "app" } )<cr>',
    opts,
  },
  {
    'n',
    '<leader>df',
    '<cmd>call vimspector#LaunchWithSettings( #{ configuration: "file" } )<cr>',
    opts,
  },
  {
    'n',
  ...
  },
  {
    'n',
    '<leader>mq',
    '<cmd>lua require("harpoon.ui").to_quickfix_list()<cr>',
    opts,
  },
  ...
  {'n', 'gD', '<cmd>lua vim.lsp.buf.declaration()<cr>', opts},
  {
    'n',
    'gd',
    '<cmd>lua require("wuilliam321.finders").lsp_definitions()<cr>',
    opts,
  },
  {'n', 'K', '<cmd>lua vim.lsp.buf.hover()<cr>', opts},
  {
    'n',
    'gi',
    '<cmd>lua require("wuilliam321.finders").lsp_implementations()<cr>',
    opts,
  },
  {'n', '<c-k>', '<cmd>lua vim.lsp.buf.signature_help()<cr>', opts},
  {
    'n',
    'gt',
    '<cmd>lua require("wuilliam321.finders").lsp_type_definitions()<cr>',
    opts,
  },
  {
    'n',
    'gr',
    '<cmd>lua require("wuilliam321.finders").lsp_references()<cr>',
    opts,
  },
  {
    'n',
  ...
  {'n', '<C-l>', ':cnext<cr>zt', opts},
  {
    'n',
    '<leader>pw',
    '<cmd>lua require("wuilliam321.finders").project_word()<cr>',
    opts,
  },
  {'n', '<leader>td', '<cmd>:vsplit<cr><cmd>:e ~/dotfiles/notes.md<cr>', opts},
  {
    'n',
    '<leader>qf',
    '<cmd>lua require("wuilliam321.finders").quickfix()<cr>',
    opts,
  },
